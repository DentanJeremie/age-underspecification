# This script is fully taken from https://github.com/yoonholee/DivDis.git repository
# Authors: Lee, Yoonho and Yao, Huaxiu and Finn, Chelsea
# Related paper: Diversify and Disambiguate: Learning From Underspecified Data
